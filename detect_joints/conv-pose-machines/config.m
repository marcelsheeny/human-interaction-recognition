...
param.model(1).caffemodel = 'model/pose_iter_985000_addLEEDS.caffemodel';
param.model(1).deployFile = 'model/pose_deploy_centerMap.prototxt';
...
param.model(2).caffemodel = 'model/pose_iter_630000.caffemodel';
param.model(2).deployFile = 'model/pose_deploy_centerMap.prototxt';
