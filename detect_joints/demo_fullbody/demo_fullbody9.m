...
opt.modelDefFile = '../../../libs/caffe-heatmap-master/models/heatmap-fullbody-9/deploy.prototxt'; % Model definition
%opt.modelFile = '../../models/heatmap-flic-fusion/caffe-heatmap-flic.caffemodel'; % Model weights
opt.modelFile = '../../../libs/caffe-heatmap-master/data/tp/nets/heatmap-fullbody-9/snapshots/heatmap_train_iter_34800.caffemodel'; % Model weights
