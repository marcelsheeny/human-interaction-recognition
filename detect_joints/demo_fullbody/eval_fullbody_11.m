...
opt.modelDefFile = '../../../libs/caffe-heatmap-master/models/heatmap-fullbody-11/matlab.prototxt'; % Model definition
%opt.modelFile = '../../models/heatmap-flic-fusion/caffe-heatmap-flic.caffemodel'; % Model weights
opt.modelFile = '../../../libs/caffe-heatmap-master/data/tp/nets/heatmap-fullbody-11/snapshots/heatmap_train_iter_255200.caffemodel'; % Model weights
...
for i=1:length(file_images)
    ...
    export_fig(['preds_fullbody_11/' file_images(i).name]);
...
save('pred_fullbody11_pc.mat','pred');
