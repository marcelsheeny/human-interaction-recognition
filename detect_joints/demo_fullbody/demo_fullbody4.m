...
opt.modelDefFile = '../../../libs/caffe-heatmap-master/models/heatmap-fullbody-4/deploy.prototxt'; % Model definition
%opt.modelFile = '../../models/heatmap-flic-fusion/caffe-heatmap-flic.caffemodel'; % Model weights
opt.modelFile = '../../../libs/caffe-heatmap-master/data/tp/nets/heatmap-fullbody-4/snapshots/heatmap_train_iter_86400.caffemodel'; % Model weights
