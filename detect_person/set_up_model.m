function model = set_up_model()
close all;
clc;
clear mex;
clear is_valid_handle; % to clear init_key
run(fullfile('..','..','libs','faster_rcnn','startup'));

%% -------------------- CONFIG --------------------
opts.caffe_version          = 'caffe-faster-rcnn';
...
%% -------------------- INIT_MODEL --------------------
model_dir                   = fullfile('..','..','libs', 'faster_rcnn', 'output', 'faster_rcnn_final', 'faster_rcnn_VOC0712_vgg_16layers'); %% VGG-16
...
model.rpn_net = rpn_net;
model.fast_rcnn_net = fast_rcnn_net; 
model.opts = opts;
model.proposal_detection_model = proposal_detection_model;
